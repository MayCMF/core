...
type File struct {
	...
	UserUUID  string    `json:"user_uuid" binding:"required"` // User ID
	...
	Filesize  int64     `json:"filesize"`                     // Filesize in bytes
	FileExt   string    `json:"file_ext" binding:"required"`  // File Extention
